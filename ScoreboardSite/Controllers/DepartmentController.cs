...
namespace ScoreboardSite.Controllers
{
    public class DepartmentController : Controller
    {
		        ...
		        catch (DbUpdateConcurrencyException ex)
		        {
			        ...
			        else
			        {
				        ...
				        ModelState.AddModelError(string.Empty, "The record you attempted to edit " +
				                                               ...
				                                               "the Save buttons again. Otherwise click the Back to List hyperlink.");
        ...
        public async Task<ActionResult> Delete(Department department)
        {
	        ...
	        {
		        ModelState.AddModelError(string.Empty, "Unable to delete. Try again, and if problem continues contact system admin");
		        return View(department);
	        }
        }
